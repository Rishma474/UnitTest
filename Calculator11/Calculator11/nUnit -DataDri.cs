...
namespace HomeTask
{
    ...
    public class NUnitTestsDataDriven
    {
        ...
        public double Add_Test(double x, double y)
        {
            cal= new Calculator();
            return cal.Add(x, y);
        }
        ...
        public double Abs_Test(double x)
        {
            cal = new Calculator();
            return cal.Abs(x);
        }
        ...
        public double Cos_Test(double x)
        {
            cal = new Calculator();
            return cal.Cos(x);
        }
        ...
        public double Divide_Test(double x,double y)
        {
            cal = new Calculator();
        ...
        public bool isNegative_Test(double x)
        {
            cal = new Calculator();
        ...
        public bool isPositive_Test(double x)
        {
            cal = new Calculator();
        ...
        public double Multipy_Test(double x,double y)
        {
            cal = new Calculator();
        ...
        public double Power_Test(double x,double y)
        {
            cal = new Calculator();
            return cal.Pow(x,y);
        }
        ...
        public double Sin_Test(double x)
        {
            cal = new Calculator();
            return cal.Sin(x);
        }
        ...
        public double Sqrt_Test(double x)
        {
            cal = new Calculator();
            return cal.Sqrt(x);
        }
        ...
        public double Sub_Test(double x, double y)
        {
            cal = new Calculator();
            return cal.Sub(x,y);
        }
